module github.com/Dennor/graphql-go-tools-bad-resolution
...
require (
	...
	github.com/wundergraph/graphql-go-tools/examples/federation v0.0.0-20230516140557-c866e35b89e1
