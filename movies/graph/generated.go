...
func (ec *executionContext) _Entity_findMovieByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNMovie2ᚖgithubᚗcomᚋDennorᚋgraphqlᚑgoᚑtoolsᚑbadᚑresolutionᚋmoviesᚋgraphᚋmodelᚐMovie(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNMovie2githubᚗcomᚋDennorᚋgraphqlᚑgoᚑtoolsᚑbadᚑresolutionᚋmoviesᚋgraphᚋmodelᚐMovie(ctx context.Context, sel ast.SelectionSet, v model.Movie) graphql.Marshaler {
	return ec._Movie(ctx, sel, &v)
}

func (ec *executionContext) marshalNMovie2ᚖgithubᚗcomᚋDennorᚋgraphqlᚑgoᚑtoolsᚑbadᚑresolutionᚋmoviesᚋgraphᚋmodelᚐMovie(ctx context.Context, sel ast.SelectionSet, v *model.Movie) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
