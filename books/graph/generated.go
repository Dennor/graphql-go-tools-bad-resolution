...
func (ec *executionContext) _Entity_findBookByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNBook2ᚖgithubᚗcomᚋDennorᚋgraphqlᚑgoᚑtoolsᚑbadᚑresolutionᚋbooksᚋgraphᚋmodelᚐBook(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNBook2githubᚗcomᚋDennorᚋgraphqlᚑgoᚑtoolsᚑbadᚑresolutionᚋbooksᚋgraphᚋmodelᚐBook(ctx context.Context, sel ast.SelectionSet, v model.Book) graphql.Marshaler {
	return ec._Book(ctx, sel, &v)
}

func (ec *executionContext) marshalNBook2ᚖgithubᚗcomᚋDennorᚋgraphqlᚑgoᚑtoolsᚑbadᚑresolutionᚋbooksᚋgraphᚋmodelᚐBook(ctx context.Context, sel ast.SelectionSet, v *model.Book) graphql.Marshaler {
	if v == nil {
